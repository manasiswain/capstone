...
if __name__ == '__main__':
    ...
    vnv = input()
    basic=['salt','sugar','pepper','oil','water','jaggery','clove','cumin','cardamom','cinnamon','turmeric','powder','masala','anise','corriander','basil','mustard','oregano']
